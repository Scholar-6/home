            ...
            <div class="dropdown-menu" role="menu">
                ...
                <?php foreach ($wp_roles->roles as $key => $value): ?>
                    <?php if (
                        ...
                        <a href="javascript:void(0)" data-role="<?php esc_attr($key); ?>" class="dropdown-item text-body font-weight-bold">
                            <?php esc_html($value['name']); ?>
                        </a>
                    <?php endif; ?>
                <?php endforeach; ?>
            </div>
...
if(!function_exists('woffice_profile_note_content')) {
    ...
    function woffice_profile_note_content() {
        ...
        <form action="<?php echo esc_attr($protocol) .'://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']; ?>" method="POST" enctype="multipart/form-data" id="woffice_user_notes">
